                ...
                <form className="col l8 s12">
                        ...
                        <div className="input-field col s12">
                            <select>
                                ...
                                <option value="2">Homeless Management Information System (HMIS)</option>
                                ...
                                <option value="7">Notices of Funding Availability (NOFAs)</option>
                        ...
                        <div className="row">
                            ...
                            <div className="input-field col s10">
                                <input 
                                    ...
                                    <span class="helper-text" data-error="Incomplete email address" >We will never use your email for marketing purposes.</span>
                            </div>
                        </div>
                        <div className="row">
                        ...
                        <button className="btn red lighten-1 ">Submit</button>
                    </form>
                    <div className="col l4">
                        <h5 style={{textAlign: "left"}}>Contact Details</h5>
                        <p>Question, comment or concern? Our contact form is the best way to get in touch with someone at LAHSA.

</p>
<h6 style={{textAlign: "left"}}>Address</h6>
<p  style={{textAlign: "left"}}>811 Wilshire Blvd, 
6th Floor, 
